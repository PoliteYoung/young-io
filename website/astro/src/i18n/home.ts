...
export const homeCopy = {
  en: {
    ...
    proof: 'Proof of work',
    portraitAlt: 'Portrait of Yaodong Yang',
    ...
    sections: {
      ...
      outputs: '05 / OUTPUTS',
      outputsTitle: ['One core.', 'Many expressions.'],
      outputsIntro: 'The same verified knowledge supports channel-specific profiles without fragmenting the source of truth.',
    ...
    identityMeanings: [
      ...
      'Connects input/output, binary 1/0, and the sounds 一/零 and 幺/洞.',
    ],
  ...
  zh: {
    ...
    explore: '探索研究与实践',
    proof: '查看代码与成果',
    portraitAlt: 'Yaodong Yang 的肖像',
    portraitId: 'Y/O — 肖像 001',
    scroll: '向下探索',
    sections: {
      position: '01 / 定位',
      ...
      publications: '04 / 发表成果',
      publicationsTitle: ['已发表工作。', '可追溯记录。'],
      publicationsIntro: '记录来自 Google Scholar，并与 DOI 注册信息及 DBLP 交叉核验；预印本和正式论文视为同一项工作，不重复计算。',
      outputs: '05 / 输出渠道',
      outputsTitle: ['同一个核心，', '多种表达。'],
      outputsIntro: '同一份经过核验的知识，可以生成适合不同渠道的身份资料，而不再让信息源彼此割裂。',
      education: '06 / 教育经历',
      educationTitle: ['跨越学科的', '研究路径。'],
      educationIntro: '教育经历依据公开的 LinkedIn 与 ORCID 记录整理。',
      writing: '07 / 随笔',
